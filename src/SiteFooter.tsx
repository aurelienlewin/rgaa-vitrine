          ...
          <ul className="mt-3 grid gap-2">
            <li>
                <a
                  ...
                  className={`inline-flex min-h-11 items-center rounded-xl border-2 border-slate-800 dark:border-slate-200 bg-slate-100 dark:bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-950 dark:text-slate-950 hover:bg-slate-200 dark:hover:bg-white ${focusRingClass}`}
                >
                  Recherche annuaire
                </a>
            </li>
