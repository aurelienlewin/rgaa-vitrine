...
Public website: **https://www.annuaire-rgaa.fr**
...
- permanent redirects that consolidate `annuaire-rgaa.fr` to `www.annuaire-rgaa.fr` and collapse trailing-slash duplicates
...
PUBLIC_APP_URL=https://www.annuaire-rgaa.fr
